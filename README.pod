...
The uninstalling is done by removing the files in the installed module's C<packlist|ExtUtils::Packlist> which is created when the module is first installed.
